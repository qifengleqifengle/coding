...
UPDATE submissions SET mode = 'selftest' WHERE mode <> 'selftest';
ALTER TABLE submissions ADD CONSTRAINT submissions_mode_check CHECK (mode = 'selftest');
ALTER TABLE submissions DROP CONSTRAINT IF EXISTS submissions_language_check;
UPDATE submissions SET language = 'java' WHERE language <> 'java';
ALTER TABLE submissions ADD CONSTRAINT submissions_language_check CHECK (language = 'java');
